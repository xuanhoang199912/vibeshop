    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center gap-2 mb-4">
              <span className="text-2xl font-display text-primary-500">Vibe</span>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li><a href="#" className="hover:text-primary-500 transition-colors">Chính Sách Đổi Trả</a></li>
              <li><a href="#" className="hover:text-primary-500 transition-colors">Chính Sách Bảo Mật</a></li>
              <li><a href="#" className="hover:text-primary-500 transition-colors">Phương Thức Vận Chuyển</a></li>
              <li><a href="#" className="hover:text-primary-500 transition-colors">Hướng Dẫn Mua Hàng</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 mt-10 pt-8 text-center text-sm text-gray-500">
          <p>&copy; 2024 VibeShop. Tất cả quyền được bảo lưu.</p>
        </div>
      </div>
    </footer>
  );
